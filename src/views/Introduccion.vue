...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-11
        .tarjeta--azul1.p-3.p-lg-5
          .row.justify-content-center
            .col-lg-3.mb-4
              figure
                img(src="@/assets/curso/temas/introduccion/img1.svg", alt="alt").img1-intro
            .col-lg-9
              .tarjeta--blanca.p-3.pl-g-4
                .row
                  .col-lg-2
                  .col-lg-10
    ...
    .row.justify-content-center.mb-5
      .col-lg-11
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/k_Nt4Z6jeQ0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
